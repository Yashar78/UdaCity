...
def entries_histogram(turnstile_weather):
    ...
    plt.figure()
    plt.subplot(2,1,1)
    turnstile_weather[turnstile_weather['rain']==1]['ENTRIESn_hourly'].hist(color='b', bins=50)
    plt.subplot(2,1,2)
    turnstile_weather[turnstile_weather['rain']==0]['ENTRIESn_hourly'].hist(color='r', bins=50)
    return plt
